...
<table id="datagrid" class="easyui-datagrid"
	   url="${ contextPath }/studentChargeInfo/list" title="学生缴费信息列表" toolbar="#tb"
	   rownumbers="true" pagination="true" pageSize="20" showFooter="true">
	<thead>
	<tr style="valign: middle">
		<th field="studentName" sortable="true" width="150px">学生姓名</th>
		<th field="chargeProjectName" sortable="true" width="150px">缴费项目</th>
		<th field="chargeAmount" sortable="true" width="150px">缴费金额</th>
		<th field="chargeTimeStr" sortable="true" width="130px">缴费时间</th>
		<th field="payTypeStr" sortable="true" width="130px">缴费方式</th>
		<th field="statusStr" width="130px" >缴费状态</th>
		<th field="prepaymentAmount" width="130px" >预缴费剩余金额</th>
