...
<table id="datagrid" class="easyui-datagrid"
	   url="${ contextPath }/charge/payProjectIolist" title="支出项目列表" toolbar="#tb"
	   rownumbers="true" pagination="true" pageSize="20" showFooter="true">
	<thead>
	<tr style="valign: middle">
		<th field="payProjectName" sortable="true" width="150px">支出项目</th>
		<th field="payAmount" sortable="true" width="150px">支出金额</th>
		<th field="payTimeStr" sortable="true" width="150px">支出时间</th>
...
<script type="text/javascript">
	...
	$('#addLink').live('click',function(){
		...
		$.ajax({
			url:"${contextPath}/charge/payProjectlist",
			dataType:'json',
			data:param,
