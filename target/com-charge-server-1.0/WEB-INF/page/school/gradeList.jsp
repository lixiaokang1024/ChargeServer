...
<script type="text/javascript">
	...
	function settings(value,row){
		...
		html += '<img style="margin:0 2px 0 1px; line-height:1.5em;cursor:pointer;" title="删除" a src="${contextPath}/images/m_delete.gif" href="javascript:;" onclick="deleteGradeInfo(\''+gradeId+'\')" />';
		html += '</div>';
		return html;
	}
	...
	//删除
	function deleteGradeInfo(gradeId){
		$.messager.confirm('系统消息', "确认删除！", function (r) {
			if (r) {
				$.ajax({
					url:  '${contextPath}/school/deleteGradeInfo',
					cache: false,
					dataType: 'json',
